-- App-specific tweaks
require("modules.apps.1password")
-- source = ~/.local/share/omarchy/default/hypr/apps/bitwarden.conf
require("modules.apps.browser")
require("modules.apps.ffplay")
require("modules.apps.freecad")
require("modules.apps.hyprshot")
